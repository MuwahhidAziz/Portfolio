# Generated by Django 5.2.1 on 2025-08-16 15:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_500', models.IntegerField()),
                ('price_250', models.IntegerField()),
                ('category', models.CharField(choices=[('General', 'General'), ('Dry Fruits', 'Dry Fruits'), ('Home Made', 'Home Made'), ('Fast Food', 'Fast Food'), ('Fruits', 'Fruits'), ('Vegetables', 'Vegetables')], default='General', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('size', models.CharField(choices=[('500g', '500 Grams'), ('250g', '250 Grams')], max_length=10)),
